...
export default function App() {
  ...
  const exportPDF = async () => {
    ...
    // Options: marges 10mm, A4 portrait, scale x2 pour la netteté, multipage auto
    const opt = {
      margin:       10,
      filename,
      ...
      pagebreak:    { mode: [""css"", ""legacy""] as const }, // respecter .html2pdf__page-break si besoin
    };

    // On clone la zone pour s’assurer d’un fond blanc plein et éviter les anims
    const el = printableRef.current;

    // Ajoute un titre en haut du PDF (facultatif)
    el.setAttribute(""data-html2pdf-ignore"", ""false"");
  ...
  return (
    <div className=""min-h-screen p-6 md:p-8 bg-gradient-to-b from-slate-50 to-zinc-100 text-slate-900"">
      <div className=""max-w-2xl mx-auto"">
        ...
        {/* Barre d’action (non incluse dans le rendu PDF) */}
        ...
        {/* Onglets (non inclus dans la capture) */}
